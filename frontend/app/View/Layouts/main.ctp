...
<body class="homepage" style="background-color:#4e3b30">
                ...
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                        ...
                        <span class="icon-bar"></span>
                                    ...
                                    <a class="navbar-brand" href="home.html"><img src="images/logosnatlia.jpg" alt="logo"></a>
                </div>
                        ...
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Telling us about the tastes, passions and happiness reflected in our inner and outer beauty perfectly</h1>
                                    <h2 class="animation animated-item-2">Batik, woven, wayang and leather are arts, they tell us things 
</h2>
                    ...
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Telling us about the tastes, passions and happiness reflected in our inner and outer beauty perfectly</h1>
                                    <h2 class="animation animated-item-2">Batik, woven, wayang and leather are arts, they tell us things </h2>
                                    <a class="btn-slide animation animated-item-3" href="#">Read More</a>
                                </div>
                            </div>
