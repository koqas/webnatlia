...
var baseUrl	=	function getBaseURL() {
...
function TimeEntry() {
	...
	this._defaults = {
		...
		spinnerImage: baseUrl() + 'img/spinnerDefault.png', // The URL of the images to use for the time spinner
...
$.extend(TimeEntry.prototype, {
	...
	_optionPlugin: function(target, options, value) {
		...
		var spinner = (!inst.options.spinnerImage ? null :
			$('<span class="' + this._controlClass + '" style="display: inline-block; margin-left:10px;' +
