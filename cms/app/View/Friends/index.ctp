                ...
                <section id="unseen">
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->Paginator->sort("$ModelName.name",'Firiends Name');?></th>
                            <th><?php echo $this->Paginator->sort("$ModelName.instansi",'Instansi Name');?></th>
                            <th><?php echo $this->Paginator->sort("$ModelName.contact",'Contact');?></th>
                        ...
                        <?php foreach($data as $data): ?>
                            ...
                            <tr <?php echo $class?>>
								...
								<td><?php echo $data[$ModelName]['instansi'] ?></td>
								<td><?php echo $data[$ModelName]['contact'] ?></td>
