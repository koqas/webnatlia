	...
	<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable">
		<thead>
			<tr>
				...
				<td>
					<?php echo $this->Paginator->sort("$ModelName.name",'Firiends Name');?>
				</td>
				<td>
					<?php echo $this->Paginator->sort("$ModelName.instansi",'Instansi Name');?>
				</td>
				<td>
					<?php echo $this->Paginator->sort("$ModelName.contact",'Contact');?>
				</td>
				<td>
