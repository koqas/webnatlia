...
<div class="page-heading">
        <h4>
            Edit <?php echo strtolower($ModelName)?>
        </h4>
        <ul class="breadcrumb">
    </ul>
</div>
	...
	<div class="row">
            <div class="col-lg-8">
                <section class="panel">
                    ...
                    <?php echo $this->Form->create($ModelName, array("type"=>"file",'url' => array("controller"=>$ControllerName,"action"=>"Edit","?"=>"debug=1"),'class' => 'form-horizontal adminex-form')); ?>
