<?php
	//echo $this->Html->script('https://maps.googleapis.com/maps/api/js?key=AIzaSyDbqx64jlcdD6efcyB-DOYBOzq30cj79hg&sensor=false');
?>
...
<div class="wrapper">
	<div class="fluid">
		...
		<div class="users form span8">
			<?php echo $this->Form->create($ModelName, array("type"=>"file",'url' => array("controller"=>$ControllerName,"action"=>"Edit", $ID),'class' => 'form', 'type' => 'file')); ?>
				<fieldset>
					<div class="widget">
						<div class="title">
						...
						<?php
						/*
							echo $this->Aimfox->printImageByImageId($this->data['Image']['id'], array(
								'fileName' => $data['Image']['attachment'],
								'imageType' => 'thumb'
							));
							echo $this->Form->input('Image.0.id', array('type' => 'hidden'));
