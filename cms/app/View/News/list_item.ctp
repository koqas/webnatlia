	...
	<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable">
		<thead>
			<tr>
				...
				<td>
					<?php echo $this->Paginator->sort("User.name", 'Author');?>
				</td>
				<td>
					<?php echo $this->Paginator->sort("$ModelName.title", 'Title');?>
				</td>
				<td>
					<?php echo $this->Paginator->sort("$ModelName.description", 'Description');?>
				</td>
				<td>
					<?php echo $this->Paginator->sort("$ModelName.published_date", 'Upload Date');?>
				</td>
				<td width="100">
		...
		<tbody>
			<?php foreach($data as $data): ?>
				...
				<tr <?php echo $class?>>
					...
					<td>
						<?php
							echo $this->Aimfox->printImageByImageId($data['Image']['id'], array(
								'fileName' => $data['Image']['attachment'],
								'imageType' => 'thumb',
								"style"		=>	"width:70px;"
							));
						?>
					...
					<td><?php echo $this->Text->truncate($data[$ModelName]['description'])?></td>
					<td><?php echo $data[$ModelName]['published_date'] ?></td>
					...
					<td>
						...
						<?php
							echo $this->Html->link(
							    'Delete',
							    array('action' => 'delete', $data[$ModelName]['id']),
							    array(),
