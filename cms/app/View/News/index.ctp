                ...
                <section id="unseen">
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <tr>
                            ...
                            <th>Image</th>
                            <th><?php echo $this->Paginator->sort("$ModelName.title", 'Title');?></th>
                            <th><?php echo $this->Paginator->sort("$ModelName.description", 'Description');?></th>
                            <th><?php echo $this->Paginator->sort("$ModelName.published_date", 'Upload Date');?></th>
