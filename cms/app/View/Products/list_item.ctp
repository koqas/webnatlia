	...
	<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable">
		<thead>
			<tr>
				...
				<td>
					<?php echo $this->Paginator->sort("$ProductCategory.name",'Product Category');?>
				</td>
				<td>
					<?php echo $this->Paginator->sort("$ModelName.name",'Product');?>
				</td>
				<td>
					<?php echo $this->Paginator->sort("$ModelName.harga",'Price');?>
				</td>
				<td>
