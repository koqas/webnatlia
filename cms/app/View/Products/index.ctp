                ...
                <section id="unseen">
                    <table class="table table-bordered table-striped table-condensed">
                        ...
                        <tr>
                            ...
                            <th>Image</th>
                            <th><?php echo $this->Paginator->sort("$ModelName.name",'Name');?></th>
                            <th><?php echo $this->Paginator->sort("$ProductCategory.name",'Product Category');?></th>
                            <th><?php echo $this->Paginator->sort("$ModelName.harga",'Price');?></th>
                        ...
                        <?php foreach($data as $data): ?>
                            ...
                            <tr <?php echo $class?>>
                                ...
                                <td><?php echo $data[$ModelName]['harga'] ?></td>
