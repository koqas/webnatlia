	...
	<table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable">
		<thead>
			<tr>
				...
				<td>
					<?php echo $this->Paginator->sort("$ModelName.username",'Username');?>
				</td>
				<td>
					<?php echo $this->Paginator->sort("Supervisor.name",'Supervisor');?>
				</td>
				<td width="100">
		...
		<tbody>
			<?php foreach($data as $data): ?>
				...
				<tr <?php echo $class?>>
					...
					<td><?php echo $data[$ModelName]['username'] ?></td>
					<td><?php echo $data['Supervisor']['name'] ?></td>
